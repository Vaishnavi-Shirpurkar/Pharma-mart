        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="background-color: #073530">
                <ul class="nav navbar-nav side-nav"style="background-color: #073530">
					...
					<li class="active"><a href="orders.php"style="background-color: #128c7e"> &nbsp; <span class='glyphicon glyphicon-list-alt'></span> My Ordered Items</a></li>
		...
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			?>
                <tr>
				 ...
				 <td><?php echo $orderitem_size; ?></td>
				 <td>&#8377; <?php echo $order_total; ?> </td>
				 <td><a href="../track-order.php">Track order</a></td>
