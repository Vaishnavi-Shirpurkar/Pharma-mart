        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="background-color: #073530">
                <ul class="nav navbar-nav side-nav"style="background-color: #073530">
					...
					<li  class="active"><a href="cart_items.php"style="background-color: #128c7e"> &nbsp; <span class='fa fa-cart-plus'></span> Shopping Cart Lists</a></li>
	...
	if($stmt->rowCount() > 0)
	{
		...
		<div class="col-xs-12">
        	<div class="alert alert-warning">
            	<span class="glyphicon glyphicon-info-sign" style="color: red"></span> &nbsp; Items once ordered can't be cancelled!
            </div>
        </div>
        <?php
	}
