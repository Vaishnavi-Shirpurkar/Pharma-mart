...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"style="background-color: #073530">
                <ul class="nav navbar-nav side-nav"style="background-color: #073530">
					...
					<li class="active"><a href="shop.php?id=1"style="background-color: #128c7e"> &nbsp; <span class='glyphicon glyphicon-shopping-cart'></span> Shop Now</a></li>
 ...
 <form role="form" method="post" action="save_order.php">
    ...
    <div class="alert alert-default" style="color:white;background-color:#073530">
		...
		<td><input class="form-control" type="hidden" name="order_size" value="400 ml/ 400 gm" /></td>
    ...
    <tr>
        ...
        <td><textarea class="form-control" cols="110" rows="3" style="resize: none;" disabled=""><?php echo $item_desc; ?></textarea>
        </td>
         </tr>
    ...
    <tr>
        ...
        <td><input class="form-control" type="number" placeholder="Quantity" min="1" max="50" name="order_quantity" value="1" onkeypress="return isNumber(event)" onpaste="return false"  required />		
		</td>
    </tr>
    ...
    <tr>
    	...
    	<td class="control-label" style="color:red">*Can't accept more than 50 items, if you need please Contact Us!*</td>
    </tr>
	
     <tr>
    	<td><label class="control-label">Size.</label></td>
        <td><input class="form-control" type="select" placeholder="Size" name="v3" value="400 ml /400 gm" onkeypress="return isNumber(event)" onpaste="return false"  disabled />	
        <option></option>	
		</td>
    </tr>
	...
	<!-- Mediul Modal -->
        <div class="modal fade" id="setAccount" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-sm">
            <div style="color:white;background-color:#073530" class="modal-content">
