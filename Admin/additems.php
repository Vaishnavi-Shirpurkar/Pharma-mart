...
$item_desp=$_POST['item_des'];
$item_qut=$_POST['item_qty'];
...
$saveitem="insert into items(item_name,item_price,item_image,item_date,item_desc,item_Qty) VALUE ('$item_name','$item_price','$itempic',CURDATE(),'$item_desp','$item_qut')";
