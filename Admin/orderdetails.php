        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"style="background-color: #073530">
                <ul class="nav navbar-nav side-nav"style="background-color: #073530">
					...
					<li class="active"><a href="orderdetails.php"style="background-color: #128c7e"> &nbsp; &nbsp; &nbsp; Order Details</a></li>
        ...
        <div id="page-wrapper">
		 ...
		 <div class="alert alert-danger">
            ...
            <table class="display table table-bordered" id="example" cellspacing="0" width="100%">
			  ...
			  <?php
include("config.php");
	$stmt = $DB_con->prepare('select order_id, order_date,users.user_firstname, users.user_lastname, order_name, order_price, order_quantity,orderitem_size, order_total from orderdetails, users where orderdetails.user_id=users.user_id and order_status="Ordered" order by order_date desc');
	$stmt->execute();
	...
	<!-- Mediul Modal -->
        <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-md">
            <div style="color:white;background-color:#128c7e" class="modal-content">
